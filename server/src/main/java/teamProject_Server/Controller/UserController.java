...
public class UserController {
    ...
    public ResponseEntity<Integer> testJoin(@RequestBody User user) {
   ...
   // 로그인
    ...
    public ResponseEntity<Integer> checkName(@RequestParam String name) {
        boolean nameExists = userService.isNameAlreadyExists(name);
        int responseCode = nameExists ? 0 : 1;
